...
import com.nvt.api.client.auth.Authentication;
import com.nvt.api.client.auth.HttpBasicAuth;
import com.nvt.api.client.auth.HttpBearerAuth;
import com.nvt.api.client.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  protected String basePath = "http://localhost:9003/api/v1";
  ...
  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    ...
    new ServerConfiguration(
      "https://celman.nvt-it.pl/public/api/v1",
      "STAGING",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api.celman.com/public/api/v1",
      "PRODUCTION",
      new HashMap<String, ServerVariable>()
    )
  ));
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    if (auth instanceof ApiKeyAuth) {
      ...
      authentications.put("ApiKeyAuth", new ApiKeyAuth("header", "X-Auth-Token"));
    }
